...
if(!isset($_REQUEST['first_name']) || $_REQUEST['first_name'] == '' || $_REQUEST['contact_email'] == '' ||  $_REQUEST['message'] == ''):
  return "error";
endif;
...
if (filter_var($_REQUEST['contact_email'], FILTER_VALIDATE_EMAIL)):
  $subject = 'Email from staging server'; // Subject of your email

  // Receiver email address
  $to = 'wgraham@clir.org';  //Change the email address by yours
