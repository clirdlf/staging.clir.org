...
<head>
	<meta charset="UTF-8">
	<title>CLIR Stating Site</title>
	<meta name="description" content="Coming Soon" >
	<meta name="author" content="CLIR">
...
<body>
	...
	<!-- Subscribe Section -->
	<section id="subscribe" class="section-style" data-background-image="images/background/about-us.jpg">
		<div class="pattern height-resize">
			<div class="container">
				<h3 class="section-name">
					<span>
				...
				<p class="section-description">
					Stay up to date on what's happing.
				...
				<div class="social-btn-container">
					<span class="social-btn-box">
						<a href="https://www.facebook.com/pages/Council-on-Library-and-Information-Resources-CLIR/300100435096" class="facebook-btn">
							<i class="fa fa-facebook"></i></a>
						</span><!-- /.social-btn-box -->

						<span class="social-btn-box">
							<a href="https://twitter.com/clirnews" class="twitter-btn"><i class="fa fa-twitter"></i></a>
						</span><!-- /.social-btn-box -->

						<span class="social-btn-box">
							<a href="https://www.linkedin.com/groups/3387265" class="linkedin-btn"><i class="fa fa-linkedin"></i></a>
						</span><!-- /.social-btn-box -->

						<span class="social-btn-box">
							<a href="http://www.youtube.com/user/DLFCLIR?blend=2&ob=0" class="youtube-btn"><i class="fa fa-youtube"></i></a>
						</span><!-- /.social-btn-box -->
		...
		<footer id="footer-section">
			<p class="copyright">
				&copy; <a href="http://clir.org">CLIR</a> 2014-2015, All Rights Reserved.
			</p>
		</footer>
		<!-- Footer Section End -->
